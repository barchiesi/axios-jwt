 ...
 * @returns {string} Access token
 */
var refreshTokenIfNeeded = function (requestRefresh, logout) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, refreshToken(requestRefresh, logout)];
            case 1:
                // do refresh
                accessToken = _a.sent();
                _a.label = 2;
 ...
 */
var refreshToken = function (requestRefresh, logout) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 7:
                ...
                if (!(status_1 === 400 || status_1 === 401 || status_1 === 422)) return [3 /*break*/, 10];
                // The refresh token is invalid so remove the stored tokens
                localStorage.removeItem(exports.STORAGE_KEY);
                if (!logout) return [3 /*break*/, 9];
                return [4 /*yield*/, logout()];
            case 8:
                _b.sent();
                _b.label = 9;
            case 9: throw new Error("Got " + status_1 + " on token refresh; clearing both auth tokens");
            case 10: 
...
var authTokenInterceptor = function (_a) {
    var _b = _a.header, header = _b === void 0 ? 'Authorization' : _b, _c = _a.headerPrefix, headerPrefix = _c === void 0 ? 'Bearer ' : _c, requestRefresh = _a.requestRefresh, logout = _a.logout;
    return function (requestConfig) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, exports.refreshTokenIfNeeded(requestRefresh, logout)];
                case 2:
                    accessToken = _a.sent();
