 ...
 * @returns {string} Access token
 */
export declare const refreshTokenIfNeeded: (requestRefresh: TokenRefreshRequest, logout: LogoutRequest) => Promise<Token | undefined>;
/**
 *
...
export declare type LogoutRequest = () => Promise<undefined>;
 ...
 */
export declare const authTokenInterceptor: ({ header, headerPrefix, requestRefresh, logout, }: IAuthTokenInterceptorConfig) => (requestConfig: AxiosRequestConfig) => Promise<AxiosRequestConfig>;
export {};
